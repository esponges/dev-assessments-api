...
import { devAssessment } from './load-data';
import { getErrorMessage } from 'src/utils/error';
import { getPineconeIndex, pinecone as pineconeClient } from '../utils';
...
const upsertVectorGroupInPineconeStore = async () => {
  ...
  try {
    ...
    await pineconeIndex.namespace('dev-questions').upsert(vectors);
  } catch (e) {
